    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Updates Channel", url="https://telegram.me/+MxH5jcG5cek5OWNl")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("Support Group", url="https://telegram.me/+MxH5jcG5cek5OWNl"),
                        InlineKeyboardButton("YouTube Channel", url="https://telegram.me/+MxH5jcG5cek5OWNl")
                    ]
                ]
            )
        )
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://telegram.me/+MxH5jcG5cek5OWNl")
                    ],
                    [
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [𝙎𝙪𝙥𝙥𝙤𝙧𝙩 𝙂𝙧𝙤𝙪𝙥](https://telegram.me/+MxH5jcG5cek5OWNl).",
                        disable_web_page_preview=True
                    )
                    return
